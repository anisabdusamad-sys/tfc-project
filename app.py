...
def init_db() -> None:
    ...
    sample_foods = [
        ...
        ("СМУЗИ БАНАН + АБРИКОС", "23", "Летнее меню", "d2.webp", "Смузи", datetime.now().strftime("%Y-%m-%d %H:%M:%S")),
        ("СМУЗИ БАНАН + МАЛИНА", "26", "Летнее меню", "d3.webp", "Смузи", datetime.now().strftime("%Y-%m-%d %H:%M:%S")),
        ("СМУЗИ БАНАН + ЯБЛОКО", "23", "Летнее меню", "d4.webp", "Смузи", datetime.now().strftime("%Y-%m-%d %H:%M:%S")),
        ("СМУЗИ БАНАН + ДЫНЯ", "21", "Летнее меню", "d5.webp", "Смузи", datetime.now().strftime("%Y-%m-%d %H:%M:%S")),
        ("СМУЗИ БАНАН + ВИШНЯ", "21", "Летнее меню", "d6.webp", "Смузи", datetime.now().strftime("%Y-%m-%d %H:%M:%S")),
        ...
        ("МОХИТО FRUITE", "19", "Летнее меню", "e3.webp", "Мохито", datetime.now().strftime("%Y-%m-%d %H:%M:%S")),
        ("МОХИТО PINEAPPLE", "19", "Летнее меню", "e4.webp", "Мохито", datetime.now().strftime("%Y-%m-%d %H:%M:%S")),
        ("МОХИТО CHERRY", "16", "Летнее меню", "e5.webp", "Мохито", datetime.now().strftime("%Y-%m-%d %H:%M:%S")),
        ("МОХИТО BLUE LAGOON", "19", "Летнее меню", "e6.webp", "Мохито", datetime.now().strftime("%Y-%m-%d %H:%M:%S")),
        ("МОХИТО БАНАНОВЫЙ", "16", "Летнее меню", "e7.webp", "Мохито", datetime.now().strftime("%Y-%m-%d %H:%M:%S")),
        ("МОХИТО KIWI", "19", "Летнее меню", "e8.webp", "Мохито", datetime.now().strftime("%Y-%m-%d %H:%M:%S")),
        ("МОХИТО APPLE", "16", "Летнее меню", "e9.webp", "Мохито", datetime.now().strftime("%Y-%m-%d %H:%M:%S")),
